package com.ph.phojuserservice.controller;
...
import com.ph.phojmodel.model.dto.user.*;
...
import com.ph.phojuserservice.config.ALiOssConfig;
...
import static com.ph.phojuserservice.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<String> upload(MultipartFile file) {
        String url = null;
        try {
            url = aLiOssConfig.uploadUserAvatar(file);
        } catch (IOException e) {
